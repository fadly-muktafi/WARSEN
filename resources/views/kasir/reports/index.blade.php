        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-light overflow-hidden shadow-lg sm:rounded-2xl border border-secondary-200">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-secondary-700">My Total Sales</h3>
                        <p class="text-3xl font-bold text-secondary-900">Rp {{ number_format($totalSales, 0, ',', '.') }}</p>
                    </div>
                </div>
                <div class="bg-light overflow-hidden shadow-lg sm:rounded-2xl border border-secondary-200">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-secondary-700">My Total Transactions</h3>
            ...
            <div class="bg-light overflow-hidden shadow-lg sm:rounded-2xl border border-secondary-200">
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-4 text-secondary-800">My Transaction Details</h3>
                            ...
                            <tbody class="divide-y divide-secondary-200">
                                @forelse ($orders as $order)
                                    <tr class="odd:bg-light even:bg-secondary-50">
                                        ...
                                        <td class="px-6 py-4 text-secondary-800">{{ $order->customer->name ?? 'N/A' }}</td>
