        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    {{-- Header Form --}}
                    <div class="mb-6">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Editing Table: {{ $table->nomor_meja }}</h3>
                        <p class="mt-1 text-sm text-gray-500">Update the table information below.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" id="nomor_meja" name="nomor_meja" value="{{ old('nomor_meja', $table->nomor_meja) }}"
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <select id="status" name="status"
                                        ...
                                        {{-- Menggunakan @selected directive untuk kode yang lebih bersih --}}
