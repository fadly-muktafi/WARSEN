        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    {{-- Header Form --}}
                    <div class="mb-6">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Editing Account: {{ $user->name }}</h3>
                        <p class="mt-1 text-sm text-gray-500">Update the user's account details below.</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <select id="role" name="role"
                                        ...
                                        <option value="waiter" @selected(old('role', $user->role) == 'waiter')>Waiter</option>
                                        <option value="kasir" @selected(old('role', $user->role) == 'kasir')>Cashier</option>
